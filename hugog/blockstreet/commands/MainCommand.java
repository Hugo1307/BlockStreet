...
public class MainCommand{
	...
	public MainCommand(Main main, CommandSender sender) {
		this.Main = main;
		this.sender = sender;
	}
	...
	protected void runMainCommand() {
		...
		if (p.hasPermission("blockstreet.admin.*")) {
		    ...
		    p.sendMessage(ChatColor.GREEN + " • /invest delete" + ChatColor.DARK_GRAY + " [Id]" + ChatColor.GRAY + " - " + messages.getMenuCreateCompanyCmd());
